...
Every recipe pins `schema_version: 28` (the current `SCENARIO_SCHEMA_VERSION`).
...
| `swapped-episode-numbers.yaml` | Two same-season episodes atomically exchange `episode_number`, crossing their paths. | converges | none |
