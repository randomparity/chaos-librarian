...
SCHEMA_VERSIONS = {
    ...
    "movie report": MOVIE_REPORT_SCHEMA_VERSION,
    "series report": SERIES_REPORT_SCHEMA_VERSION,
    "season report": SEASON_REPORT_SCHEMA_VERSION,
    "episode report": EPISODE_REPORT_SCHEMA_VERSION,
    "artist report": ARTIST_REPORT_SCHEMA_VERSION,
    "album report": ALBUM_REPORT_SCHEMA_VERSION,
    "disc report": DISC_REPORT_SCHEMA_VERSION,
    "track report": TRACK_REPORT_SCHEMA_VERSION,
