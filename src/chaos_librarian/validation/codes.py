...
E_SYMLINK_TARGET_ESCAPE: Final = "E_SYMLINK_TARGET_ESCAPE"
...
E_PROFILE_BUDGET_EXCEEDED: Final = "E_PROFILE_BUDGET_EXCEEDED"
E_MATERIALIZE_UNSUPPORTED: Final = "E_MATERIALIZE_UNSUPPORTED"
